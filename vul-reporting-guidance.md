...
Vulnerabilities found in working group Internet-Drafts or individual submission documents that have expired, or were fixed in subsequent versions; published RFCs that are marked historic; or RFCs documenting work defined the outside the IETF are unlikely to have action taken on them. 
